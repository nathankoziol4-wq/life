...
> **Note locale à ce dépôt.** Ce skill ne se déclenche que sur appel
> explicite. Sa description d'origine lui demande de s'activer sur tout
> composant ou interface web, avant tout choix de taille, d'espacement ou
> de rayon — or Odyssia a son propre système de jetons
> (`src/ui/theme/tokens.css`, échelle de rayons 8/12/18/26/34/999) et pas
> de Tailwind, alors que la section B3 impose « only use Tailwind's radius
> values ». Laissé automatique, il contredirait le système à chaque écran.
>
> Il reste utile tel quel le jour où l'on voudra une page de présentation
> du jeu : `Skill(landing-page-design)`.
