...
| ---: | ---: | --- | --- | --- |
| 1 | 3.0 | `MISSING` | Carrière/Collection/Registre des métiers exercés | aucune collection de carrières : exercer trente métiers ne laisse aucune trace |
| 2 | 3.0 | `MISSING` | Carrière/Cumul/Deuxième employeur | un seul contrat de travail à la fois |
| 3 | 3.0 | `MISSING` | Crime/Trafic/Économie de contrebande fictive | — |
| 4 | 3.0 | `MISSING` | Entreprise/Employés/Salariés comme PNJ | l’effectif est un nombre ; seul le gérant est une personne |
| 5 | 3.0 | `MISSING` | Entreprise/Produit/Un produit avec qualité et demande propres | l’entreprise vend « du chiffre » : aucun produit nommé, aucun lancement |
| 6 | 3.0 | `MISSING` | Événements/Densité/Audit d’âge automatique | la densité par tranche d’âge se mesure à la main, pas en continu |
| 7 | 3.0 | `MISSING` | Héritage/Collections/Registre des collections | — |
| 8 | 3.0 | `MISSING` | Héritage/Lignée/Arbre généalogique | la lignée est une liste ; aucun arbre à parcourir |
| 9 | 3.0 | `MISSING` | Patrimoine/Objets/Objets de famille transmis | — |
| 10 | 3.0 | `MISSING` | Prison/Émeute/Mini-jeu dédié | — |
