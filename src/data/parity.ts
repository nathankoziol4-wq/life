...
export const PARITY_MATRIX: ParityEntry[] = [
  ...
  },
  {
    ...
    ours: 'getAvailableActions(état, cible, contexte) : une seule source, et chaque action bloquée dit pourquoi',
    depth: 4, priority: 1, status: 'PARTIAL',
    missingInteractions: ['contextes travail et prison encore vides'],
