...
export const PARITY_MATRIX: ParityEntry[] = [
  ...
  },
  {
    ...
    ours: 'Neuf engagements du bar au stade, dont titre, album et tournée, joués sur scène',
    depth: 4, priority: 2, status: 'PARTIAL',
    missingInteractions: ['groupe et musiciens', 'label comme entité', 'ventes et classements'],
    miniGame: 'performance',
