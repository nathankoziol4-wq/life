...
const SPECIAL: Feature[] = [
  ...
  f('Carrières spéciales/Acteur/Échelle de salaires', 'PLACEHOLDER', { src: 'data/jobs.ts', ui: 'screens/OccupationScreen.tsx', pers: 1, deps: ['Carrière'], impact: 2, note: 'le métier « comédien » de la grille reste un salaire ; la carrière jouée vit ailleurs' }),
  f('Carrières spéciales/Acteur/Auditions', 'PARTIAL', { src: 'systems/stage.ts#rollOffers', ui: 'screens/StageScreen.tsx', test: 'scene', pers: 1, cons: 1, impact: 4, note: 'on est retenu ou non selon son niveau, mais l’essai lui-même ne se joue pas' }),
  ...
  f('Carrières spéciales/Musique/Échelle de salaires', 'PLACEHOLDER', { src: 'data/jobs.ts', ui: 'screens/OccupationScreen.tsx', pers: 1, deps: ['Carrière'], impact: 2, note: 'le métier « musicien » de la grille reste un salaire' }),
  ...
  f('Carrières spéciales/Musique/Groupe et compagnons', 'MISSING', { impact: 4, note: 'ni auditions de musiciens, ni répétitions, ni départs' }),
  f('Carrières spéciales/Musique/Maison de disques', 'PLACEHOLDER', { src: 'systems/stage.ts#rollOffers', ui: 'screens/StageScreen.tsx', deps: ['Carrières spéciales/Scène'], impact: 3, note: 'la maison qui propose est une formule, pas une entité avec un contrat' }),
  f('Carrières spéciales/Musique/Sortir un titre ou un album', 'PARTIAL', { src: 'data/stage.ts#JOB_TEMPLATES', ui: 'screens/StageScreen.tsx', test: 'scene', pers: 1, cons: 1, impact: 4, note: 'le titre et l’album sont des engagements avec un accueil ; ni ventes, ni classement' }),
  ...
  f('Carrières spéciales/Politique/Métier existant', 'PLACEHOLDER', { src: 'data/jobs.ts', ui: 'screens/OccupationScreen.tsx', pers: 1, deps: ['Carrière'], impact: 2, note: 'le métier « politique » de la grille reste un salaire' }),
  f('Carrières spéciales/Politique/Campagne électorale', 'PARTIAL', { src: 'data/stage.ts#JOB_TEMPLATES', ui: 'screens/StageScreen.tsx', test: 'scene', pers: 1, cons: 1, impact: 4, note: 'la candidature est un engagement qui se tient et se gagne ; ni programme, ni budget, ni adversaire nommé' }),
  ...
  f('Carrières spéciales/Politique/Exercer le mandat', 'PARTIAL', { src: 'data/stage.ts#JOB_TEMPLATES', ui: 'screens/StageScreen.tsx', test: 'scene', pers: 1, cons: 1, impact: 4, note: 'le mandat se tient et se juge, mais on n’y prend aucune décision de fond' }),
  f('Carrières spéciales/Politique/Réélection et scandales', 'PARTIAL', { src: 'systems/stage.ts#settleJob', ui: 'screens/StageScreen.tsx', test: 'scene', pers: 1, cons: 1, deps: ['Notoriété'], impact: 3, note: 'un mauvais mandat nourrit la controverse et les affaires ; la réélection est une distinction, pas un vote' }),
  f('Carrières spéciales/Mannequin/Métier existant', 'PLACEHOLDER', { src: 'data/jobs.ts', ui: 'screens/OccupationScreen.tsx', pers: 1, deps: ['Carrière'], impact: 2, note: 'le métier « mannequin » de la grille reste un salaire' }),
  f('Carrières spéciales/Mannequin/Agence et book', 'PARTIAL', { src: 'systems/stage.ts#hireAgent', ui: 'screens/StageScreen.tsx', test: 'scene', npc: 1, pers: 1, cons: 1, impact: 3, note: 'l’agence existe et négocie ; le book, non' }),
