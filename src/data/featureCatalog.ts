...
const SPECIAL: Feature[] = [
  ...
  f('Carrières spéciales/Politique/Métier existant', 'PLACEHOLDER', { src: 'data/jobs.ts', ui: 'screens/OccupationScreen.tsx', pers: 1, deps: ['Carrière'], impact: 2, note: 'le métier « politique » de la grille reste un salaire ; la carrière jouée vit ailleurs' }),
