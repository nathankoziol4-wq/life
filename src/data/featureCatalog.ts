...
const CORE: Feature[] = [
  ...
  f('Vie/Création/Composer sa famille', 'PARTIAL', { src: 'systems/originGen.ts#resolveDraft', ui: 'screens/CreationScreen.tsx', test: 'berceau', npc: 1, pers: 1, cons: 1, deps: ['Relations/Famille'], impact: 4, note: 'structure du foyer et fratrie (nombre, sexe, écart d’âge) deviennent de vraies personnes aux bons âges — vérifié ; le métier et l’âge des parents restent tirés' }),
