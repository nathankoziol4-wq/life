...
const CORE: Feature[] = [
  ...
  f('Vie/Personnalité/Habitudes qui coûtent', 'PARTIAL', { src: 'systems/psyche.ts#advanceHabits', ui: 'components/PersonalityPanel.tsx', pers: 1, cons: 1, test: 'personnalite', deps: ['Finance', 'Santé'], impact: 3, note: 'on ne peut toujours pas en prendre ni en perdre une délibérément ; mais ce qu’elles coûtaient était faux — la fréquence montait d’une douzaine d’occurrences par an sans fin, jusqu’à 98 heures de loisirs par semaine à cinquante ans et un temps libre réduit à 1,4' }),
