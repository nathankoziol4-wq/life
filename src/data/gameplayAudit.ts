...
const CHILDHOOD: AuditLeaf[] = [
  ...
  },
  {
    ...
    gap: 'aucune activité familiale : un enfant ne peut rien faire *avec* sa famille',
    connects: [],
  },
  {
    domain: 'Enfance', system: 'Amis d’enfance', leaf: 'Amis hors école',
    depth: 'MISSING', priority: 2,
    gap: 'les seuls enfants du monde sont les camarades de classe',
    connects: [],
  },
  {
    domain: 'Enfance', system: 'Premières passions', leaf: 'Découvrir un intérêt et le cultiver',
    depth: 'PARTIAL', anchor: 'src/systems/exposure.ts#exposureSignals', priority: 2,
    gap: 'l’exposition crée des intérêts passivement ; l’enfant ne choisit rien',
    connects: ['personnalité'],
  },
  {
    domain: 'Enfance', system: 'Événements', leaf: 'Banque d’événements 0-12 ans',
    depth: 'BASIC', anchor: 'src/data/events/childhood.ts', priority: 1,
    gap: 'huit événements éligibles en moyenne avant 5 ans, vingt-cinq avant 10, contre plus de quatre-vingts à l’âge adulte',
    connects: ['événements'],
  },
  {
...
const WORK: AuditLeaf[] = [
  ...
  {
    domain: 'Travail', system: 'Cumul', leaf: 'Deuxième emploi, temps partiel cumulé',
    depth: 'MISSING', priority: 2,
    gap: 'un seul emploi possible : ni cumul, ni arbitrage temps/fatigue/revenu',
    connects: [],
  },
  {
    domain: 'Travail', system: 'Indépendant', leaf: 'Petits services, activité artistique, contenu',
    depth: 'MISSING', priority: 1,
    gap: 'aucune activité rémunératrice hors salariat : un chômeur n’a rien à faire',
    connects: [],
  },
  {
    domain: 'Travail', system: 'Entreprise', leaf: 'Créer, gérer, développer, vendre une entreprise',
    depth: 'MISSING', priority: 1,
    gap: 'le mot « entreprise » n’existe que comme employeur : on ne peut pas en posséder une',
    connects: [],
  },
  {
